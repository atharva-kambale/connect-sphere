...
const CreateListingPage = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      setUploading(false);
      imagePreviews.forEach(url => URL.revokeObjectURL(url));
      navigate('/market'); // Go to market on success
    } catch (createError) {
  ...
  return (
    <FormContainer>
      ...
      <form onSubmit={submitHandler} className="flex flex-col space-y-4">
        ...
        {/* Image Upload */}
        <div className="flex flex-col space-y-1">
          <label htmlFor="images" className="font-medium text-gray-700 dark:text-gray-300">Images (Max 5)</label>
          <input
            type="file" id="images"
        ...
        {/* Messages */}
        {uploading && <p className="text-blue-600 font-semibold dark:text-blue-400">Uploading and Submitting... Please wait...</p>}
