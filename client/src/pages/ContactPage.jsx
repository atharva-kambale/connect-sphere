  ...
  return (
    ...
    <div className="max-w-2xl mx-auto p-4 pt-24">
      <div className="bg-white p-8 md:p-12 rounded-xl shadow-lg border border-gray-200
        ...
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-6 border-b dark:border-gray-700 pb-4 text-center">
          Contact Our Team
        </h1>
        ...
        <form onSubmit={submitHandler} className="space-y-4">
          ...
          <div className="flex flex-col space-y-1">
            <label htmlFor="name" className="font-medium text-gray-700 dark:text-gray-300">Your Name</label>
          ...
          <div className="flex flex-col space-y-1">
            <label htmlFor="email" className="font-medium text-gray-700 dark:text-gray-300">Your Email</label>
          ...
          <div className="flex flex-col space-y-1">
            <label htmlFor="message" className="font-medium text-gray-700 dark:text-gray-300">Message</label>
